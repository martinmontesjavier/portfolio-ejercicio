import dopefolioImage from '../imagenes/dopefolio.jpeg';
    ...
    <div className="container mx-auto p-4 mt-10 lg:mt-24">
      ...
      <div className="flex flex-col lg:flex-row mt-10">
        <div className="lg:w-1/2">
          <img src={dopefolioImage} className="w-full" alt="Dopefolio"></img>
        </div>
        <div className="lg:w-1/2 p-6 lg:p-24">
          ...
          <button className="py-3 px-8 mt-4 lg:mt-8 font-bold text-white bg-purple-600 rounded-md shadow-md hover:bg-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-opacity-50">
            CASE STUDY
          </button>
        </div>
      </div>
